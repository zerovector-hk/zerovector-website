export default {
  ...
  tech: {
    title: '技術與方法',
    sub: '一條可複核的分析管線：每一步都有明確的產出與留痕。',
    stages: [
      { title: '數據接入', desc: '全節點與多源鏈上數據採集，統一清洗、校驗與標準化。', tag: '產出：鏈上原始數據集' },
      { title: '圖譜構建', desc: '地址聚類與交易關係建模，構建可查詢的資金流圖譜。', tag: '產出：交易關係圖譜' },
      { title: '歸因分析', desc: '行為建模與跨鏈追蹤，形成可複核的歸因結論。', tag: '產出：歸因分析結論' },
      { title: '證據輸出', desc: '證據保全與鏈式保管，產出符合司法程序要求的報告。', tag: '產出：法庭級取證報告' },
    ],
